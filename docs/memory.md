...
- `pytest` (backend) → **96 passed** — perintah: `cd backend` lalu `.\.venv\Scripts\python.exe -m pytest -q` (bukan `python` polos; gunakan venv project).
